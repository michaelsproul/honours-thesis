...
The proof of type soundness for the linear lambda calculus consists of a collection of lemmas and definitions, culminating in the proofs of \textbf{preservation} and \textbf{progress} which together establish soundness.

We say that a lemma or definition is \textit{language-specific} if it relates to features of the language 

can be divided into parts which are unique to the language itself, and parts which are universally applicable to any
