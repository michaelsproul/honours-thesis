...
% FIXME: Maybe include something about rules with premises. Reference full set of semantics for LLC on page...
...
% TODO: Fill in the remaining semantic rules.
\begin{eqnarray*}
...
\item How are typing contexts represented? How is context splitting implemented? These questions are the topic of the upcoming sections: \cref{sec:repr-ty-contexts}. % FIXME.
\end{itemize}
...
\textbf{Emptiness} Lemmas about empty contexts as the identity element for context splitting are provable using a few lines of proof script. For details, see \c{Context.v}. % FIXME: name.
...
%In our previous discussion about representing typing contexts, we saw the myriad.
