...
Without a \c{split_single} definition, inversion of \c{context_split (e :: raw_insert x' None E') (e1 :: E1') (e2 :: E2')} forces us to consider the cases where \c{e1 = None /\ e2 = Some t} and \c{e1 = Some t /\ e2 = None} separately. The proof was originally conducted in this style, but it was much more cumbersome. The two separate cases required different calls to the \c{exists} tactic; \c{exists (None :: E1'), (Some t, E2')} and \c{exists (Some t :: E1'), (None :: E2')}.
