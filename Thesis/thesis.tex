...
To handle the case where \c{x >= length E} and padding \c{None} values are inserted, we note that all the values past the end of the old environment will all be \c{None}. Equipped with a simple definition of a \c{repeat} function on lists, and some lemmas about list append, this case is proved.
