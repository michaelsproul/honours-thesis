...
% L^3 stuff.
\newcommand{\Ptr}[1]{\text{Ptr $#1$}}
\newcommand{\ptr}[1]{\text{ptr $#1$}}
\newcommand{\Capa}[2]{\text{Cap $#1$ $#2$}}
\newcommand{\capa}{\text{cap}}
\newcommand{\lquine}{\left\ulcorner}
\newcommand{\rquine}{\right\urcorner}
\newcommand{\dupl}[1]{\text{dupl $#1$}}
\newcommand{\drop}[1]{\text{drop $#1$}}
\newcommand{\lnew}[1]{\text{new $#1$}}
\newcommand{\lfree}[1]{\text{free $#1$}}
\newcommand{\lswap}[3]{\text{swap $#1$ $#2$ $#3$}}
