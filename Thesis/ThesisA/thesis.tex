...
$L^3$'s rules for managing capabilities are closer to standard linear typing than Clean's uniqueness typing. Part of the reason for this is that capabilities are intended to be erased at compile time, and as such considerations of FIXME.
